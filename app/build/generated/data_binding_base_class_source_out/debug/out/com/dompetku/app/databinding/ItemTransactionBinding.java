...
public final class ItemTransactionBinding implements ViewBinding {
  ...
  private ItemTransactionBinding(@NonNull MaterialCardView rootView,
      @NonNull ImageView ivCategoryIcon, @NonNull TextView tvAccountName,
      @NonNull TextView tvAmount, @NonNull TextView tvCategoryName, @NonNull TextView tvDate,
  ...
  public static ItemTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTransactionBinding((MaterialCardView) rootView, ivCategoryIcon, tvAccountName,
          tvAmount, tvCategoryName, tvDate, tvNote);
    }
