...
public final class ActivityLockBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout layoutPinDots;

  @NonNull
  public final TextView tvPinSubtitle;

  @NonNull
  public final TextView tvPinTitle;

  private ActivityLockBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btn0,
      ...
      @NonNull MaterialButton btnBackspace, @NonNull MaterialButton btnBiometric,
      ...
      @NonNull GridLayout gridKeypad, @NonNull LinearLayout layoutPinDots,
      @NonNull TextView tvPinSubtitle, @NonNull TextView tvPinTitle) {
    ...
    this.dot5 = dot5;
    this.dot6 = dot6;
    this.gridKeypad = gridKeypad;
    this.layoutPinDots = layoutPinDots;
    this.tvPinSubtitle = tvPinSubtitle;
  ...
  public static ActivityLockBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.grid_keypad;
      GridLayout gridKeypad = ViewBindings.findChildViewById(rootView, id);
      if (gridKeypad == null) {
        break missingId;
      }

      id = R.id.layout_pin_dots;
      LinearLayout layoutPinDots = ViewBindings.findChildViewById(rootView, id);
      if (layoutPinDots == null) {
        break missingId;
      }

      id = R.id.tv_pin_subtitle;
      TextView tvPinSubtitle = ViewBindings.findChildViewById(rootView, id);
      if (tvPinSubtitle == null) {
        break missingId;
      }

      id = R.id.tv_pin_title;
      TextView tvPinTitle = ViewBindings.findChildViewById(rootView, id);
      if (tvPinTitle == null) {
        break missingId;
      }

      return new ActivityLockBinding((LinearLayout) rootView, btn0, btn1, btn2, btn3, btn4, btn5,
          btn6, btn7, btn8, btn9, btnBackspace, btnBiometric, dot1, dot2, dot3, dot4, dot5, dot6,
          gridKeypad, layoutPinDots, tvPinSubtitle, tvPinTitle);
    }
