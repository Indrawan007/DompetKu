...
public abstract class Hilt_AddTransactionBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddTransactionBottomSheet() {
    super();
  }

  Hilt_AddTransactionBottomSheet(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddTransactionBottomSheet_GeneratedInjector) this.generatedComponent()).injectAddTransactionBottomSheet(UnsafeCasts.<AddTransactionBottomSheet>unsafeCast(this));
    }
  }
