...
public abstract class Hilt_SetBudgetBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SetBudgetBottomSheet() {
    super();
  }

  Hilt_SetBudgetBottomSheet(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SetBudgetBottomSheet_GeneratedInjector) this.generatedComponent()).injectSetBudgetBottomSheet(UnsafeCasts.<SetBudgetBottomSheet>unsafeCast(this));
    }
  }
