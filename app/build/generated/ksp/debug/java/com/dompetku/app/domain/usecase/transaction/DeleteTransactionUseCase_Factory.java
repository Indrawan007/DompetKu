...
public final class DeleteTransactionUseCase_Factory implements Factory<DeleteTransactionUseCase> {
  ...
  public DeleteTransactionUseCase_Factory(
  ...
  public static DeleteTransactionUseCase_Factory create(
      Provider<TransactionRepository> transactionRepositoryProvider,
      Provider<AccountRepository> accountRepositoryProvider) {
    return new DeleteTransactionUseCase_Factory(transactionRepositoryProvider, accountRepositoryProvider);
  }

  public static DeleteTransactionUseCase newInstance(TransactionRepository transactionRepository,
