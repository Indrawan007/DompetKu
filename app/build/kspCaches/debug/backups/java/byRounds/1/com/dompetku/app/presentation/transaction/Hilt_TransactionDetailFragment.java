...
public abstract class Hilt_TransactionDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TransactionDetailFragment() {
    super();
  }

  Hilt_TransactionDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransactionDetailFragment_GeneratedInjector) this.generatedComponent()).injectTransactionDetailFragment(UnsafeCasts.<TransactionDetailFragment>unsafeCast(this));
    }
  }
